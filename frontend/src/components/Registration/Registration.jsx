...
const Registration = (props) => {
    const { registerClient, registerOrganizer } = useStoreActions(actions => actions.userStore);

    const [activeTab, setActiveTab] = useState("clientRegister");
    ...
    const registerClientClickedHandler = () => {
        let valid = true;
    ...
    const registerOrganizerClickedHandler = async () => {
        let valid = true;
    ...
    return (
        <div className={classes.Register}>
            <Tabs
                defaultActiveKey="clientRegister"
                transition={false}
                id="noanim-tab-example"
                className="mb-3"
                onSelect={activeTabChanged}
            >
                <Tab eventKey="clientRegister" title="As client">
                    <Form>
                        ...
                        <Button onClick={registerClientClickedHandler}>Register</Button>
                    </Form>
                </Tab>
                <Tab eventKey="organizerRegister" title="As organizer">
                    <Form className={classes.OrganizerRegister}>
                        <h3 className="h3 text-center">Register</h3>
                        ...
                        <Button onClick={registerOrganizerClickedHandler}>Register</Button>
                    </Form>
                </Tab>
            </Tabs>
        </div >
